...
describe("transaction", () => {
  ...
  test("it should get list quote max success", async () => {
    let existWalletAccount = "0x018ecb581400d4050edce0a7a57cda4b336f0e80e859c8db33f0d619ddb80f89";
    const tt = await moneyFi.getMaxQuotesAmount({sender: existWalletAccount}); 
    console.log(tt); 
  });
}); 
